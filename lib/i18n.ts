...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    hero: {
      ...
      slideAlts2: [
        "Maison Coffee's booth at Cafe Show Hanoi, with shelves of Maison Specialty coffee and a staff member preparing a pour-over",
        "Maison Coffee's exhibition stand at Cafe Show Hanoi, with our coffee story and production process on display",
        "Maison Coffee team members at an international trade show booth in Bangkok",
        "A Maison Coffee team member brewing pour-over coffee at the Bangkok trade show booth",
        "Visitors gathered at the Maison Coffee booth at a coffee trade show",
        "A cupping demonstration of Maison Coffee at a trade show, filmed for television",
        "Visitors browsing Maison Specialty coffee at our export trade show booth",
        "A Maison Coffee team member preparing coffee for a visitor at a crowded trade show aisle",
        "The Maison Coffee team at an international trade show, with a cupping set and our farm-to-cup spec card",
      ],
  ...
  vi: {
    ...
    hero: {
      ...
      slideAlts2: [
        "Gian hàng Maison Coffee tại Cafe Show Hà Nội, với các kệ cà phê Maison Specialty và nhân viên đang pha pour-over",
        "Gian trưng bày Maison Coffee tại Cafe Show Hà Nội, giới thiệu câu chuyện và quy trình sản xuất cà phê",
        "Đội ngũ Maison Coffee tại gian hàng hội chợ quốc tế ở Bangkok",
        "Nhân viên Maison Coffee pha cà phê pour-over tại gian hàng hội chợ ở Bangkok",
        "Khách tham quan tụ tập tại gian hàng Maison Coffee ở một hội chợ cà phê",
        "Buổi thử nếm (cupping) cà phê Maison tại hội chợ, được ghi hình cho truyền hình",
        "Khách tham quan xem cà phê Maison Specialty tại gian hàng hội chợ xuất khẩu",
        "Nhân viên Maison Coffee pha cà phê cho khách tại lối đi đông đúc của hội chợ",
        "Đội ngũ Maison Coffee tại một hội chợ quốc tế, cùng bộ dụng cụ cupping và thẻ thông số nông trại",
      ],
      prevLabel: "Ảnh trước",
